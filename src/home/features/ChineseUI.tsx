  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <h1 className="mb-2 text-2xl font-bold sm:text-3xl">中文網頁</h1>
          ...
          >
            <Feature icon={<BsShieldFillCheck />}>yeecord 網站模板</Feature>
            <Feature icon={<BsTextCenter />}>個人記事用</Feature>
            <Feature icon={<RiMouseFill />}>無商業用途</Feature>
          </div>
        </Step>
        <Gradient
          src={GardientSvg}
...
function Skeleton() {
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="text-lg font-bold sm:text-xl">webside</h2>
